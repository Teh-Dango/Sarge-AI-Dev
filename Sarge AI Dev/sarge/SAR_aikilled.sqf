...
if (_ai_xp < SAR_AI_XP_LVL_2) then {_ai_xp_type = SAR_AI_XP_NAME_1;};
if (_ai_xp >= SAR_AI_XP_LVL_2 && _ai_xp < SAR_AI_XP_LVL_3) then {_ai_xp_type = SAR_AI_XP_NAME_2;};
if (_ai_xp >= SAR_AI_XP_LVL_3) then {_ai_xp_type = SAR_AI_XP_NAME_3;};

if (_ai_killer_xp < SAR_AI_XP_LVL_2) then {_ai_killer_xp_type = SAR_AI_XP_NAME_1;};
if (_ai_killer_xp >= SAR_AI_XP_LVL_2 && _ai_killer_xp < SAR_AI_XP_LVL_3) then {_ai_killer_xp_type = SAR_AI_XP_NAME_2;};
if (_ai_killer_xp >= SAR_AI_XP_LVL_3) then {_ai_killer_xp_type = SAR_AI_XP_NAME_3;};
